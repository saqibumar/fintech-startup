...
class PersonalInfo extends React.Component {
  constructor(props) {    
    ...
    this.state = {
      ...
      formValid: this.props.form.formValid===''? true:false,
  ...
  validateField(fieldName, value) {
    ...
    switch(fieldName) {
      ...
      break;
        ...
        break;
        case 'Street':
            fieldValidationErrors.Street ='';
            if(value.trim()===''){
              fieldValidationErrors.Street = ' es requerido';
            }
        break;
        case 'ExteriorNumber':
            fieldValidationErrors.ExteriorNumber ='';
          if(value.trim()===''){
            fieldValidationErrors.ExteriorNumber = ' es requerido';
          }
        break;
        case 'Colony':
            fieldValidationErrors.Colony ='';
          if(value.trim()===''){
        ...
        break;
        case 'FixedPhone':
            fieldValidationErrors.FixedPhone ='';
  ...
  validateForm() {
    ...
    if(this.state.token)
    {
      this.setState(
        {formValid: 
          ...
          (this.state.ExteriorNumber && this.state.ExteriorNumber.toString().trim()) && 
          (this.state.Colony && this.state.Colony.trim()) && 
          (this.state.Town && this.state.Town.trim()) && 
          (this.state.City && this.state.City.trim()) && 
          (this.state.State && this.state.State.trim()) && 
    ...
    else
    {
      this.setState(
        {formValid: 
          ...
          (this.state.phone && this.state.phone.trim() && this.state.phoneValid) && 
          (this.state.Street && this.state.Street.trim()) && 
          (this.state.ExteriorNumber && this.state.ExteriorNumber.trim()) && 
          (this.state.Colony && this.state.Colony.trim()) && 
          (this.state.Town && this.state.Town.trim()) && 
          (this.state.City && this.state.City.trim()) && 
          (this.state.State && this.state.State.trim()) && 
    ...
    //("formValid state and props = ",this.state.formValid, this.props.form.formValid);
        ...
        <form id="formReg">
          ...
          <div className="col-md-6 col-lg-6 col-xl-6 col-sm-12 col-xs-12">
            ...
            <div className="col-md-3 col-lg-3 col-xl-3 col-sm-6 col-xs-6">
              ...
              <input name="ExteriorNumber" placeholder="Exterior Number" value={this.props.form.ExteriorNumber} 
                 autoComplete="on"
            ...
            <div className="col-md-3 col-lg-3 col-xl-3 col-sm-6 col-xs-6">
              ...
              <input name="InteriorNumber" placeholder="Interior Number" value={this.props.form.InteriorNumber} 
                 autoComplete="on"
          ...
          <div className="col-md-6 col-lg-6 col-xl-6 col-sm-12 col-xs-12">
              ...
              <input name="FixedPhone" placeholder="Fixed Phone" value={this.props.form.FixedPhone} 
                autoComplete="on" type="text" maxLength="10"
            ...
            <div className="col-12 form-footer">
              <div className="row">
                <div className="col-12">
                  ...
                  <button className="btn -primary pull-right" type="submit"
                    /* disabled={(!this.props.form.formValid)} */
    ...
    //()=>{
      ...
      // ("formValid", this.props.form.formValid);
        ...
        const { data } = this.props.form;
          ...
          .then(()=>{
            this.props.saveValues("PendingStepNumber", 3);
